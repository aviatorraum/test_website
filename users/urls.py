...
from .views import (activate, activation_complete, register,
                    registration_closed, registration_complete, home, details)

urlpatterns = [
    url(r'^$', home, {'template_name': 'base.html'}, name='home'),
    url(r'^profile/$', details, {'template_name': 'profile.html'}, name='user_details'),
