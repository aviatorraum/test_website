...
@never_cache
def home(request,
         template_name='users/home.html.html',
...
def register(request,
    ...
    # mark here to test registration format as a logined user
...
def details(request,
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            user_info = get_object_or_404(User, email=form.email)

    return TemplateResponse(request, template_name, {'form': user_info})
